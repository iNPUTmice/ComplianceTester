Use compliance suite 'Advanced Server Core Compliance Suite' to test adastra.re
...
Use compliance suite 'Advanced Server IM Compliance Suite' to test adastra.re
...
Use compliance suite 'Advanced Server Mobile Compliance Suite' to test adastra.re
...
Use compliance suite 'Conversations Compliance Suite' to test adastra.re
